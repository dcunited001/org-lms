...
#+PROPERTY: header-args :tangle org-lms.el :comments link
                  ...
                  (let* ((fname (plist-get stu :firstname))
                         ...
                         (props 
                          `(("GRADE" . "0")
                            ...
                            ;; ("MAIL_CC" . (or user-mail-address "matt.price@utoronto.ca"))
                  ...
                  (let* ((fname (plist-get stu :firstname))
                         ...
                         (props 
                          `(("GRADE" . "0")
                            ...
                            ("MAIL_REPLY" . (user-mail-address "matt.price@utoronto.ca"))
                            ("MAIL_SUBJECT" .
